...
public class LibroModelImpl extends BaseModelImpl<Libro> implements LibroModel {
	...
	static {
		...
		attributeGetterFunctions.put("escritor", Libro::getEscritor);
		attributeSetterBiConsumers.put(
			"escritor", (BiConsumer<Libro, String>)Libro::setEscritor);
	...
	public String getOriginalTitulo() {
		return getColumnOriginalValue("titulo");
	}
	...
	public Libro cloneWithOriginalValues() {
		...
		libroImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		libroImpl.setLibroId(this.<Long>getColumnOriginalValue("libroId"));
		libroImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		libroImpl.setCompanyId(this.<Long>getColumnOriginalValue("companyId"));
		libroImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		libroImpl.setUserName(this.<String>getColumnOriginalValue("userName"));
		libroImpl.setCreateDate(
			this.<Date>getColumnOriginalValue("createDate"));
		libroImpl.setModifiedDate(
			this.<Date>getColumnOriginalValue("modifiedDate"));
		libroImpl.setTitulo(this.<String>getColumnOriginalValue("titulo"));
		libroImpl.setEscritor(this.<String>getColumnOriginalValue("escritor"));
		libroImpl.setPublicacion(
			this.<Date>getColumnOriginalValue("publicacion"));
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<Libro, Object> function = _attributeGetterFunctions.get(
			columnName);
		...
		return (T)function.apply((Libro)this);
	}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("libroId", _libroId);
		...
		_columnOriginalValues.put("escritor", _escritor);
		_columnOriginalValues.put("publicacion", _publicacion);
	}
	...
	static {
		...
		columnBitmasks.put("escritor", 512L);

		columnBitmasks.put("publicacion", 1024L);
